  ...
  return (
    <div>
      ...
      <div className="userContext"> 
        ...
        <p style={{ margin: "20px 0 0 45px", fontSize: "1rem", fontFamily: "Questrial" }}>Jacob has eaten 1,300 calories and 62g protein so far today. <span className="goal">He has had 1tbsp of extra virgin olive oil and an estimated 11g of fiber.</span> He has consumed a bowl of yogurt, coffee, pastry, beef stick, granola bar, and a morning drink with honey, collagen peptides, and longevity mix.</p>
        <h2 style={{ margin: "40px 0 0 40px", fontFamily: "Questrial" }}>This Week:</h2>
        <p style={{ margin: "20px 0 0 40px", fontFamily: "Questrial" }}>Jacob has eaten within his goal of 2,000 calories every day this week. <span className="goal">Yesterday he ate 2,050 calories</span> and the day before he has 1,970 calories. He has eaten an average of 124g of protein per day. He has been drinking coffee daily, having a morning drink of collagen peptides, honey, and longevity mix daily, has been having around 15 additional supplements daily, and has been eating a diet consisting of yogurt bowls, nutty pudding, beef sticks, extra virgin olive oil shots, and miscellaneous other foods. He has been having 2tbsp of olive oil per day on average and 10-15g of fiber per day.</p>
...
<span className="goal">Jacob's goal is to eat 2,000 calories, 130g of protein, and 3tbsp of extra virgin olive oil per day.</span></p>
      </div>
    </div>
  );
}